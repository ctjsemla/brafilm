// Catálogo Brafilm — capas e metadados de superflixbr.com (TMDB CDN)
...
export const featured = {
  ...
  logoImage: 'https://image.tmdb.org/t/p/w500/yaSolQdphRLOUWvtBvtYF4tNEO7.png',
  rating: 10.0,
  year: 2026,
  type: 'Série',
  description:
...
/** Lançamentos — 16 filmes (referência superflix) */
...
/** Mais filmes — segunda fileira na home */
...
export const seriesEmAlta = [
  ...
  serie({ id: 111, title: 'La Casa de Papel', rating: 8.2, year: 2021, poster: p('/reEMJA1JzoIfvN9qNpIn2Y8PaEo.jpg'), slug: 'la-casa-de-papel' }),
  serie({ id: 112, title: 'Round 6', rating: 7.9, year: 2021, poster: p('/ggFHVNu6YYI5L9n4jb8s26xJtTJ.jpg'), slug: 'round-6' }),
]
